      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
          <div className="md:col-span-2">
            <h3 className="text-2xl font-bold mb-6 text-gray-900">VeriText</h3>
            <p className="text-gray-700 mb-6 max-w-sm">
              Advanced AI content detection for professionals who value authenticity and originality in their content.
            </p>
          ...
          <div>
            <h4 className="text-lg font-bold mb-4 text-gray-900">Product</h4>
          ...
          <div>
            <h4 className="text-lg font-bold mb-4 text-gray-900">Resources</h4>
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-600 hover:text-primary transition-colors">API Reference</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-600 hover:text-primary transition-colors">Sales</a></li>
              <li><a href="#" className="text-gray-600 hover:text-primary transition-colors">Report Bug</a></li>
              <li><a href="#" className="text-gray-600 hover:text-primary transition-colors">Request Feature</a></li>
            </ul>
          </div>
        </div>
        
        <div className="border-t border-gray-200 mt-12 pt-8 text-sm text-gray-500">
          <p>© {new Date().getFullYear()} VeriText. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
